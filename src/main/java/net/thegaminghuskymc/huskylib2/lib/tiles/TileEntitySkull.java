...
import net.thegaminghuskymc.huskylib2.lib.blocks.EnumBlockSkull;
...
public class TileEntitySkull extends TileEntity implements ITickable {
    ...
    public void mirror(Mirror mirrorIn) {
        if (this.world != null && this.world.getBlockState(this.getPos()).getValue(EnumBlockSkull.FACING) == EnumFacing.UP) {
