...
public class ItemPickaxeSubBase extends ItemPickaxeBase{
	
	private String itemName;
	private String[] subNames;
	
	public ItemPickaxeSubBase(ToolMaterial material, String name, CreativeTabs tabs) {
		super(material, name, tabs);
		this.itemName = name;
		this.subNames = null;
	}
	
	public ItemPickaxeSubBase(ToolMaterial material, String name, CreativeTabs tabs, String... subNames) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		if(!StringHelper.isShiftKeyDown()){
			...
			tooltip.add(Names.ItemToolTips.WIP_PICKAXE);
	}
