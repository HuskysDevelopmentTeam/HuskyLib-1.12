...
import net.thegaminghuskymc.huskylib2.lib.block_module.BlockModule;
import net.thegaminghuskymc.huskylib2.lib.entity_module.EntityModule;
import net.thegaminghuskymc.huskylib2.lib.item_module.ItemModule;
import net.thegaminghuskymc.huskylib2.lib.lib.LibMisc;
import net.thegaminghuskymc.huskylib2.lib.rendering_module.RenderingModule;
...
public final class ModuleLoader {
	...
	static {
		...
		registerModule(BlockModule.class);
		registerModule(EntityModule.class);
		registerModule(ItemModule.class);
		registerModule(RenderingModule.class);
	}
	...
	public static HashMap<Class<? extends Module>, Module> moduleInstances = new HashMap();
	static HashMap<Class<? extends Feature>, Feature> featureInstances = new HashMap();
	...
	public static void preInit(FMLPreInitializationEvent event) {
		...
		forEachModule(module -> FMLLog.info("[HuskyLib] Module " + module.name + " is " + (module.enabled ? "enabled" : "disabled")));
