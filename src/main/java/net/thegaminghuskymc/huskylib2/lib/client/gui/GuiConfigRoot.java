...
public class GuiConfigRoot extends GuiConfigBase {
	...
	public GuiConfigRoot(GuiScreen parent) {
		...
		qEnabled = GlobalConfig.enableHlButton;
	}
	...
	public void initGui() {
		...
		x = width / 2;
		y = startY + 113;
		buttonList.add(new GuiButtonConfigSetting(x + 80, y, GlobalConfig.hlButtonProp, true, I18n.translateToLocal("hl2.config.enablehl")));
		buttonList.add(new GuiButton(1, x - 100, y + 22, 200, 20, I18n.translateToLocal("hl2.config.general")));
		buttonList.add(new GuiButton(2, x - 100, y + 44, 98, 20, I18n.translateToLocal("hl2.config.import")));
		buttonList.add(new GuiButton(3, x + 2, y + 44, 98, 20, I18n.translateToLocal("hl2.config.opensite")));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(mayRequireRestart)
			s = I18n.translateToLocal("hl2.config.needrestart");
		else if(qEnabled && !GlobalConfig.enableHlButton)
			s = I18n.translateToLocal("hl2.config.hldisabled");
