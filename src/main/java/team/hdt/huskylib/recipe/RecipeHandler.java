...
import team.hdt.huskylib.interf.IRecipeGrouped;
...
//            throw new RuntimeException(e);
    ...
    public static void addRecipe(ResourceLocation res, IRecipe recipe) {
        ...
        if(!(recipe instanceof ModRecipe))
            System.out.println("[HuskyLib] Not instance of ModRecipe - " + res.toString());

        if(recipe.getRecipeOutput().isEmpty())
            System.out.println("[HuskyLib] Recipe output empty - " + res.toString());
