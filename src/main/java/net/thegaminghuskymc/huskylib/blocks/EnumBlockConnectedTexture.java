...
public class EnumBlockConnectedTexture<E extends Enum<E> & EnumBlock.IEnumMeta & IStringSerializable> extends EnumBlock<E> {
    ...
    public EnumBlockConnectedTexture(Material material, String name, CreativeTabs creativeTabs, PropertyEnum<E> prop, Class<E> clazz) {
      super(material, name, creativeTabs, prop, clazz);
